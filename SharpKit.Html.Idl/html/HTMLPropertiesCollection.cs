...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/html/HTMLPropertiesCollection.idl
...
[JsType(JsMode.Prototype, NativeEnumerator = false, NativeArrayEnumerator = true, Export = false, PropertiesAsFields = true, OmitCasts = true, Name = "HTMLPropertiesCollection")]
public partial class HtmlPropertiesCollection : HtmlCollection, IJsArrayEnumerable<Node>
{
	...
	[JsProperty(NativeIndexer = true)]
	public  NodeList this[string name] {get { return default(NodeList); } set {}}
