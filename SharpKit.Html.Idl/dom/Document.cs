...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/dom/Document.idl
...
public partial class Document : Node
{
	...
	public  object getCSSCanvasContext(string contextId, string name, int width, int height) { return default(object); }
	...
	public  EventListener onwebkitpointerlockchange {get; set; }
	public  EventListener onwebkitpointerlockerror {get; set; }
}
