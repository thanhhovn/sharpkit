...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/loader/appcache/DOMApplicationCache.idl
...
public partial class DOMApplicationCache
{
	...
	public  void abort() {}
	public  EventListener onchecking {get; set; }
	public  EventListener<ErrorEvent> onerror {get; set; }
	public  EventListener onnoupdate {get; set; }
	public  EventListener ondownloading {get; set; }
	public  EventListener<ProgressEvent> onprogress {get; set; }
	public  EventListener onupdateready {get; set; }
	public  EventListener oncached {get; set; }
	public  EventListener onobsolete {get; set; }
