...
namespace SharpKit.DotNet.JavaScript
{
    ...
    public partial class JsArray<T> : IJsArrayEnumerable<T>
    {
        ...
        ///</remarks>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "pop")]
        ...
        ///<param name="items">Optional. Additional items to add to the end of the current array.</param>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "concat")]
        ...
        ///</remarks>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "splice")]
        ...
        ///</remarks>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "slice")]
        ...
        /// Documentation from MDN.
        ///</summary>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "some")]
        ...
        /// Documentation from MDN.
        ///</summary>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "forEach")]
        public void ForEach(JsAction<JsObject, JsNumber, JsArray<T>> callback) { }
        ///<summary>
        ///Returns an Array object with the elements reversed.
        ///</summary>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "reverse")]
        public JsArray<T> Reverse() { return default(JsArray<T>); }
        ///<summary>
        ///Removes the first element from an array and returns that element.
        ///</summary>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "shift")]
        public T Shift() { return default(T); }
        ///<summary>
        ///Inserts specified elements into the beginning of an array.
        ///</summary>
        ///<returns></returns>
        [JsMethod(NativeOverloads = true, IgnoreGenericArguments = true, Name = "unshift")]
        ...
        ///</summary>
        ///<param name="sortFunction">Optional. OriginalValue of the function used to determine the order of the elements.</param>
        [JsMethod(NativeOverloads = true, NativeDelegates = true, Name = "sort")]
    ...
    public partial class JsContext
    {
        ...
        [JsMethod(OmitParanthesis = true, Name = "debugger")]
        ...
        [JsMethod(OmitParanthesis = true, NativeOverloads = true, Name = "return")]
        ...
        [JsMethod(OmitParanthesis = true, NativeOverloads = true, Name = "throw")]
        ...
        [JsMethod(OmitParanthesis = true, NativeOverloads = true, Name = "delete")]
    ...
    public partial class JsError : Exception
    {
        ...
        public JsString JsToString() { return default(JsString); }
    }
    ...
    public static partial class JsMath
    {
        ...
        [JsMethod(Name = "round", NativeOverloads = true)]
        //        [JsMethod(Name = "round")]
    ...
    public partial class JsNumber : JsObjectBase, IConvertible, IComparable, IComparable<JsNumber>, IEquatable<JsNumber>, IFormattable
    {
        ...
        // [JsMethod(NativeOverloads = true)]
        [JsMethod(Name = "toString")]
        public new JsString JsToString() { return default(JsString); }
        ///<summary>
        ///Returns a JsString representation of an object.
        ///</summary>
        ...
        // [JsMethod(NativeOverloads = true)]
        [JsMethod(Name = "toString")]
        public JsString JsToString(int radix) { return default(JsString); }
        ///<summary>
        ///Returns the primitive value of the specified object.
        ///</summary>
    ...
    public abstract partial class JsObjectBase
    {
        ...
        [JsMethod(Name = "toString")]
        public virtual JsString JsToString() { return default(JsString); }
    ...
    public static partial class JsExtensions
    {
        ...
        public static JsString AsJsString(this Enum s) { return new JsString(s); }
        /// <summary>
...
namespace SharpKit.DotNet.JavaScript.Server
{
