...
namespace Ext
{
    ...
    public partial class ModelManager : AbstractManager
    {
        ...
        /// </summary>
        public static object create(object data, JsString name, JsNumber id){return null;}
        /// <summary>
        /// Returns the Ext.data.Model for a given model name ...
        /// </summary>
        public static object getModel(object id){return null;}
        public static JsArray associationStack{get;set;}
