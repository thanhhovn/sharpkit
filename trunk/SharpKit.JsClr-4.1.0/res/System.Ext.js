...
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Runtime.Serialization.IExtensibleDataObject",baseTypeName:"System.Object",isInterface:true,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{System.Object.ctor.call(this);}},staticDefinition:{IsStatic:function(pi)
{return pi._IsStatic;},IsPublic:function(pi)
{throw new Error('Not Implemented');}},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"SharpKit.PropertyInfoExtensions",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{System.Object.ctor.call(this);}},staticDefinition:{GetValueOrDefaultIfNullOrEmpty:function(s,defaultValue)
...
{var sb=new System.Text.StringBuilder.ctor();var first=true;var $it12=s.GetEnumerator();while($it12.MoveNext())
{var c=$it12.get_Current();if(System.Char.IsUpper$$Char(c)&&!first)
{sb.Append$$Char(' ');}
...
{return System.String.Compare$$String$$String$$Boolean(s1,s2,true)==0;}},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"SharpKit.Extensions2",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{System.Object.ctor.call(this);}},staticDefinition:{escape:function(s)
...
{return obj[funcName].apply(obj,Arguments.from(arguments,2));},FindOverloadedMethodName:function(obj,funcName)
...
{return unescape(s)},undefined:null},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"SharpKit.JavaScript.Utils.Js",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{System.Object.ctor.call(this);}},staticDefinition:{JsFunctionNameToClrMethodName:function(jsFuncName)
...
{var $it13=prms.GetEnumerator();while($it13.MoveNext())
{var prm=$it13.get_Current();sb.Append$$String("$$");sb.Append$$String(prm.get_ParameterType().get_Name());}},ClrMethodBaseToJsFunctionName:function(mi)
...
{sb.Append$$String(SharpKit.JavaScript.JsNamingHelper.ClrTypeToJsTypeRef(type));var att=System.Linq.Enumerable.FirstOrDefault$$IEnumerable$1("SharpKit.JavaScript.JsTypeAttribute",System.Linq.Enumerable.OfType("SharpKit.JavaScript.JsTypeAttribute",type.GetCustomAttributes$$Type$$Boolean(Typeof(SharpKit.JavaScript.JsTypeAttribute),false)));if(att==null||att.get_Mode()==2)
...
{var name=mi.get_Name();return name.StartsWith$$String("set_")&&mi.GetParameters().get_Length()==1;}},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"SharpKit.JavaScript.JsNamingHelper",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})