...
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:true,definition:{},staticDefinition:{CreateInstance:"CreateInstance",DeclaredOnly:"DeclaredOnly",Default:"Default",ExactBinding:"ExactBinding",FlattenHierarchy:"FlattenHierarchy",GetField:"GetField",GetProperty:"GetProperty",IgnoreCase:"IgnoreCase",IgnoreReturn:"IgnoreReturn",Instance:"Instance",InvokeMethod:"InvokeMethod",NonPublic:"NonPublic",OptionalParamBinding:"OptionalParamBinding",Public:"Public",PutDispProperty:"PutDispProperty",PutRefDispProperty:"PutRefDispProperty",SetField:"SetField",SetProperty:"SetProperty",Static:"Static",SuppressChangeType:"SuppressChangeType"},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:null,fullname:"System.Reflection.BindingFlags",baseTypeName:null,isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{this._Name=null;this._DeclaringType=null;this._CustomAttributes=null;System.Object.ctor.call(this);},Name$$:"System.String",get_Name:function()
...
{if(inherit)
throw new System.NotImplementedException.ctor$$String("GetCustomAttributes with inherit=true is not implemented");this.VerifyCustomAttributes();return this._CustomAttributes;}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Reflection.MemberInfo",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{System.Reflection.MemberInfo.ctor.call(this);}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Reflection.MethodBase",baseTypeName:"System.Reflection.MemberInfo",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
...
res=func.apply(obj,parameters);return res;}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Reflection.MethodInfo",baseTypeName:"System.Reflection.MethodBase",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function()
{this._PropertyType=null;this._IsStatic=false;this._Getter=null;this._Setter=null;System.Reflection.MemberInfo.ctor.call(this);},Name$$:"System.String",get_Name:function()
...
{var arr=new Array(indexes);arr.push(value);this._Setter.apply(obj,(indexes!=null?indexes:new Array()));}}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Reflection.PropertyInfo",baseTypeName:"System.Reflection.MemberInfo",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function(jsType)
{this._JsType=null;this.allPropertiesVerified=false;this._PropertiesByName=null;this._Properties=null;this._MethodsByName=null;this._Methods=null;this.verifiedCustomAttributesOnTypeAndMembers=false;this._GenericTypeDefinition=null;this._TypeArguments=null;this._MakeGenericTypeCache=null;System.Reflection.MemberInfo.ctor.call(this);this._JsType=jsType;this._Name=this._JsType.name;if(System.Type.EmptyTypes==null)
...
{return JsTypeHelper.GetName(this._JsType);},FullName$$:"System.String",get_FullName:function()
{return this._JsType.fullname;},AssemblyQualifiedName$$:"System.String",get_AssemblyQualifiedName:function()
{return JsTypeHelper.GetAssemblyQualifiedName(this._JsType);},GetBaseMember:function()
...
{var $it9=baseType.GetProperties().GetEnumerator();while($it9.MoveNext())
{var pe=$it9.get_Current();if(!this._PropertiesByName.hasOwnProperty(pe._Name))
...
{var $it10=baseType.GetMethods().GetEnumerator();while($it10.MoveNext())
{var pe=$it10.get_Current();if(this._MethodsByName[pe._Name]==null)
...
{var attDef=this._JsType.customAttributes[i];var attType=JsTypeHelper.GetType(attDef.typeName);var jsCtor=attType[attDef.ctorName];var att=SharpKit.JavaScript.Utils.Js.ApplyNew(jsCtor,attDef.positionalArguments);if(attDef.namedArguments!=null)
...
{var methodName=SharpKit.JavaScript.JsNamingHelper.JsFunctionNameToClrMethodName(memberName);var $it11=this.GetMethods$$String(methodName).GetEnumerator();while($it11.MoveNext())
{var method=$it11.get_Current();if(method.JsName==memberName)
return method;}
return null;}
...
return t;}},staticDefinition:{_TypeOf:function(jsType)
{if(jsType==null)
...
{var jsTypeAndArgs=JsTypeHelper._GetTypeWithArguments(name,throwOnError);if(jsTypeAndArgs==null)
...
var jsType=JsTypeHelper.GetType(name);if(jsType==null)
{if(throwOnError)
...
{if(ignoreCase)
throw new System.NotImplementedException.ctor();return System.Type.GetType$$String$$Boolean(name,throwOnError);},EmptyTypes:null},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Type",baseTypeName:"System.Reflection.MemberInfo",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})