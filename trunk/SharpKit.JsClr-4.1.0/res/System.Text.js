...
{this.array=null;this.length=0;System.Object.ctor.call(this);this.array=[];this.length=0;},ctor$$String:function(s)
{this.array=null;this.length=0;System.Object.ctor.call(this);this.array=[s];this.length=s==null?0:s.get_Length();},Length$$:"System.Int32",get_Length:function()
...
{var s=this.array.join("");s=s.Remove$$Int32$$Int32(start,count);this.array=[s];this.length=s.length;return this;}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Text.StringBuilder",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})