...
namespace YUI_
{
    ...
    public partial class WidgetButtons
    {
        ...
        /// already exist.
        /// </summary>
        protected void _uiInsertButton(Node button, object section, YUI_.DataType_.Number index){}
        /// <summary>
        ...
        /// * `src`: "add"
        /// </summary>
        public void addButton(object button, YUI_.DataType_.Number index){}
        /// <summary>
        /// Adds a button to this widget.
        /// The new button node will have the `Y.Plugin.Button` plugin applied, be added
        /// to this widget's `buttons`, and rendered in the specified `section` at the
        ...
        /// * `src`: "add"
        /// </summary>
        public void addButton(object button, object section, YUI_.DataType_.Number index){}
        /// <summary>
        ...
        /// </summary>
        public YUI_.Array NON_BUTTON_NODE_CFG{get;set;}
    }
}
