...
namespace YUI_
{
    ...
    public partial class Plots
    {
        ...
        /// </summary>
        protected object _getItemColor(YUI_.Array val, YUI_.DataType_.Number i){return null;}
        /// <summary>
        ...
        /// it will create one.
        /// </summary>
        protected Shape getMarker(object styles, YUI_.DataType_.Number order, YUI_.DataType_.Number index){return null;}
        /// <summary>
