...
namespace SharpKit.JavaScript.Compilation
{
    ...
    public class JsCompilerGlobal : BrowserContext
    {
        ...
        private static object FromBool(object obj, string type)
        {
            if (type == "System.String")
                return (int)obj == 0 ? "False" : "True";
            if (type == "System.Char")
                return (int)obj == 0 ? 'F':'T';
        ...
        private static object FromNumber(object obj, string type)
        {
            if (type == "System.String")
        ...
        private static object Cast(object obj, string typeOrName)
        {
            if (obj == null)
                return obj;
            var type = JsTypeHelper.GetType(typeOrName, true);
            var test = TryConvert(obj, typeOrName);
            if (test != null)
                return test;
