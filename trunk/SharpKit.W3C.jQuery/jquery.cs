...
namespace SharpKit.jQuery
{
	...
	public partial class Map : CSSStyleDeclaration
	{
		...
		public JsString this[int index] {
			get { throw new NotImplementedException(); }
		}

		public JsString getPropertyValue(string property) {
			throw new NotImplementedException();
		}

		public JsString getPropertyPriority(string property) {
			throw new NotImplementedException();
		}

		public void setProperty(string property, JsString value) {
			throw new NotImplementedException();
		}

		public void setProperty(string property, JsString value, JsString priority) {
			throw new NotImplementedException();
		}

		public JsString removeProperty(string property) {
			throw new NotImplementedException();
		}

		public CSSStyleDeclarationValue values {
			get { throw new NotImplementedException(); }
		}
