...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/html/HTMLAllCollection.idl
...
[JsType(JsMode.Prototype, NativeEnumerator = false, NativeArrayEnumerator = true, Export = false, PropertiesAsFields = true, OmitCasts = true, Name = "HTMLAllCollection")]
public partial class HtmlAllCollection : IJsArrayEnumerable<Node>
{
	...
	public  NodeList tags(string name) { return default(NodeList); }
