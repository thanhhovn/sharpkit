...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/html/track/TextTrackCue.idl
...
{
	public   TextTrackCue(string id, double startTime, double endTime, string text, string settings, bool pauseOnExit) {}
	...
	public  EventListener onenter {get; set; }
	public  EventListener onexit {get; set; }
