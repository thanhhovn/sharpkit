...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/Modules/indexeddb/IDBTransaction.idl
...
public partial class IDBTransaction
{
	...
	public  static int VERSION_CHANGE = 2;
	public  JsString mode {get; set; }
	public  IDBDatabase db {get; set; }
	public  DOMError error {get; set; }
	public  IDBObjectStore objectStore(string name) { return default(IDBObjectStore); }
	public  void abort() {}
