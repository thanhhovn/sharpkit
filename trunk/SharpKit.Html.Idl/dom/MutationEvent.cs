...
/****************************************************************************************************
  ...
  Content was generated from IDL file: http://trac.webkit.org/browser/trunk/Source/WebCore/dom/MutationEvent.idl
...
public partial class MutationEvent : DOMEvent
{
	...
	public  int attrChange {get; set; }
	public  void initMutationEvent(string type, bool canBubble, bool cancelable, Node relatedNode, string prevValue, string newValue, string attrName, int attrChange) {}
}
