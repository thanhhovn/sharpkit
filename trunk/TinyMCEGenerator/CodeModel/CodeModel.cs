...
namespace SharpKit.TinyMCE.Generator
{
    class Class : Element
    {
        public Class()
    ...
    class Method : Element
    {
        ...
        public override string UniqueName
        {
            get
            {
                ...
                var prms = Parameters.Select(t => (t != null && t.Type != null) ? t.Type.UniqueName : "").StringConcat(",");
                return name + "(" + prms + ")";
            }
        }
    ...
    class Assembly
    {
        ...
        {
            return AllClasses.Where(t => string.Equals(t.FullName, fullName, StringComparison.OrdinalIgnoreCase)).FirstOrDefault();
        }
    ...
    static class CodeModelExtensions
    {
        ...
        public static IEnumerable<Event> Events(this Class ce)
        {
            return ce.Members.OfType<Event>();
        }
