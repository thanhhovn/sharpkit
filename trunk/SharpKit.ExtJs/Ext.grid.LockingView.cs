...
namespace Ext.grid
{
    ...
    /// <inheritdocs />
    /// <summary>
    /// <p><strong>NOTE</strong> This is a private utility class for internal use by the framework. Don't rely on its existence.</p><p>This class is used internally to provide a single interface when using
    ...
    public partial class LockingView : Ext.Base, Ext.util.Observable
    {
        /// <summary>
        ...
        public LockingView(LockingViewConfig config){}
        public LockingView(){}
        public LockingView(params object[] args){}
    }
    #endregion
    #region LockingViewConfig
    /// <inheritdocs />
    [JsType(JsMode.Json, Export=false, OmitOptionalParameters=true)]
    public partial class LockingViewConfig : Ext.BaseConfig
    {
        /// <summary>
        /// A config object containing one or more event handlers to be added to this object during initialization. This
        /// should be a valid listeners config object as specified in the addListener example for attaching multiple
        ...
        /// </summary>
        public JsObject listeners;
        public LockingViewConfig(params object[] args){}
    }
    #endregion
    #region LockingViewEvents
    /// <inheritdocs />
    [JsType(JsMode.Json, Export=false, OmitOptionalParameters=true)]
    public partial class LockingViewEvents : Ext.BaseEvents
    {
        public LockingViewEvents(params object[] args){}
    }
    #endregion
}
#endregion
