...
namespace Ext.data
{
    ...
    /// <inheritdocs />
    /// <summary>
    /// <p>Contains a collection of all stores that are created that have an identifier. An identifier can be assigned by
    /// setting the <see cref="Ext.data.AbstractStoreConfig.storeId">storeId</see> property. When a store is in the StoreManager, it can be
    ...
    /// storeId: 'myStore'
    /// });
    /// var store = <see cref="Ext.data.StoreManager.lookup">Ext.data.StoreManager.lookup</see>('myStore');
    /// </code></pre>
    /// <p>Also note that the <see cref="Ext.data.StoreManager.lookup">lookup</see> method is aliased to <see cref="Ext.ExtContext.getStore">Ext.getStore</see> for convenience.</p>
    ...
    public partial class StoreManager : Ext.util.MixedCollection
    {
        /// <summary>
        ...
        /// </div>
        /// </returns>
        public StoreManager(bool allowFunctions, System.Delegate keyFn){}
        /// <summary>
        ...
        /// </div>
        /// </returns>
        public static Ext.data.Store lookup(object store){return null;}
        /// <summary>
        ...
        /// </summary>
        /// <param name="stores"><p>Any number of Store instances</p>
        /// </param>
        public static void register(Ext.data.Store stores){}
        /// <summary>
        ...
        /// </summary>
        /// <param name="stores"><p>Any number of Store instances or ID-s</p>
        /// </param>
        public static void unregister(object stores){}
        public StoreManager(StoreManagerConfig config){}
        public StoreManager(){}
        public StoreManager(params object[] args){}
    }
    #endregion
    ...
    {
        public StoreManagerConfig(params object[] args){}
    }
    #endregion
    ...
    {
        public StoreManagerEvents(params object[] args){}
    }
    #endregion
}
