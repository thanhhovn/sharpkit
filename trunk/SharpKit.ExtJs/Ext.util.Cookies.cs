...
namespace Ext.util
{
    ...
    /// <inheritdocs />
    /// <summary>
    /// <p>Utility class for setting/reading values from browser cookies.
    /// Values can be written using the <see cref="Ext.util.Cookies.set">set</see> method.
    /// Values can be read using the <see cref="Ext.util.Cookies.get">get</see> method.
    /// A cookie can be invalidated on the client machine using the <see cref="Ext.util.Cookies.clear">clear</see> method.</p>
    /// </summary>
    ...
    public partial class Cookies : Ext.Base
    {
        ...
        /// </summary>
        /// <param name="name"><p>The name of the cookie to remove</p>
        /// </param>
        /// <param name="path"><p>The path for the cookie.
        /// This must be included if you included a path while setting the cookie.</p>
        /// </param>
        public static void clear(JsString name, object path=null){}
        /// <summary>
        /// </summary>
        ...
        /// <code>var validStatus = <see cref="Ext.util.Cookies.get">Ext.util.Cookies.get</see>("valid");
        /// </code>
        /// </summary>
        /// <param name="name"><p>The name of the cookie to get</p>
        /// </param>
        /// <returns>
        /// <span><see cref="Object">Object</see></span><div><p>Returns the cookie value for the specified name;
        ...
        /// <summary>
        /// Parameters<li><span>offset</span> : <see cref="Object">Object</see><div>
        /// </div></li>
        /// </summary>
        /// <param name="offset">
        /// </param>
        private static void getCookieVal(object offset){}
        /// <summary>
        ...
        /// </summary>
        /// <param name="name"><p>The name of the cookie to set.</p>
        /// </param>
        /// <param name="value"><p>The value to set for the cookie.</p>
        /// </param>
        /// <param name="expires"><p>Specify an expiration date the cookie is to persist until. Note that the specified Date
        /// object will be converted to Greenwich Mean Time (GMT).</p>
        /// </param>
        /// <param name="path"><p>Setting a path on the cookie restricts access to pages that match that path. Defaults to all
        /// pages ('/').</p>
        /// </param>
        /// <param name="domain"><p>Setting a domain restricts access to pages on a given domain (typically used to allow
        ...
        /// </param>
        /// <param name="secure"><p>Specify true to indicate that the cookie should only be accessible via SSL on a page
        ...
        /// </param>
        public static void set(JsString name, object value, object expires=null, object path=null, object domain=null, object secure=null){}
        /// <summary>
        /// Parameters<li><span>config</span> : <see cref="Object">Object</see><div>
        ...
        public Cookies(){}
        public Cookies(params object[] args){}
    }
    #endregion
    ...
    {
        public CookiesConfig(params object[] args){}
    }
    #endregion
    ...
    {
        public CookiesEvents(params object[] args){}
    }
    #endregion
}
