...
namespace Ext
{
    ...
    /// <inheritdocs />
    /// <summary>
    /// <p>Provides a registry of available Plugin classes indexed by a mnemonic code known as the Plugin's ptype.</p>
    /// <p>A plugin may be specified simply as a <em>config object</em> as long as the correct <c>ptype</c> is specified:</p>
    /// <pre><code>{
    ...
    /// </code></pre>
    /// <p>Alternatively you can instantiate the plugin with <see cref="Ext.ExtContext.create">Ext.create</see>:</p>
    /// <pre><code><see cref="Ext.ExtContext.create">Ext.create</see>('<see cref="Ext.grid.plugin.DragDrop">Ext.grid.plugin.DragDrop</see>', {
    /// dragText: 'Drag and drop to reorganize'
    /// })
    /// </code></pre>
    /// </summary>
    ...
    public partial class PluginManager : AbstractManager
    {
        ...
        /// instantiate.
        /// </summary>
        /// <param name="config"><p>A configuration object for the Plugin you wish to create.</p>
        /// </param>
        /// <param name="defaultType"><p>The constructor to provide the default Plugin type if the config object does not
        /// contain a <c>ptype</c>. (Optional if the config contains a <c>ptype</c>).</p>
        /// </param>
        /// <returns>
        /// <span><see cref="Ext.Component">Ext.Component</see></span><div><p>The newly instantiated Plugin.</p>
        /// </div>
        /// </returns>
        ...
        /// </summary>
        /// <param name="type"><p>The type to search for</p>
        /// </param>
        /// <param name="defaultsOnly"><p>True to only return plugins of this type where the plugin's isDefault property is
        /// truthy</p>
        /// </param>
        /// <returns>
        /// <span><see cref="Ext.AbstractPlugin">Ext.AbstractPlugin</see>[]</span><div><p>All matching plugins</p>
        /// </div>
        /// </returns>
        public static AbstractPlugin[] findByType(JsString type, bool defaultsOnly){return null;}
        /// <summary>
        ...
        public PluginManager(params object[] args){}
    }
    #endregion
    ...
    {
        public PluginManagerConfig(params object[] args){}
    }
    #endregion
    ...
    {
        public PluginManagerEvents(params object[] args){}
    }
    #endregion
}
