...
namespace Ext.menu
{
    ...
    /// <inheritdocs />
    /// <summary>
    /// <p>Provides a common registry of all menus on a page.</p>
    /// </summary>
    ...
    public partial class Manager : Ext.Base
    {
        ...
        /// </summary>
        /// <param name="menu"><p>The string menu id, an existing menu object reference, or a Menu config that will
        /// be used to generate and return a new Menu this.</p>
        /// </param>
        /// <returns>
        /// <span><see cref="Ext.menu.Menu">Ext.menu.Menu</see></span><div><p>The specified menu, or null if none are found</p>
        /// </div>
        /// </returns>
        ...
        /// </summary>
        /// <returns>
        /// <span><see cref="bool">Boolean</see></span><div><p>success True if any active menus were hidden.</p>
        /// </div>
        /// </returns>
