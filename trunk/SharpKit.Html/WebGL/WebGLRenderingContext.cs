namespace SharpKit.Html
{
    ...
    public partial class WebGLRenderingContext
    {
        ...
        public static int ACTIVE_UNIFORM_MAX_LENGTH = 0x8B87;
        public static int ACTIVE_ATTRIBUTES = 0x8B89;
        public static int ACTIVE_ATTRIBUTE_MAX_LENGTH = 0x8B8A;
        ...
        public static int EXTENSIONS = 0x1F03;
        ...
        public static int IMPLEMENTATION_COLOR_READ_TYPE = 0x8B9A;
        public static int IMPLEMENTATION_COLOR_READ_FORMAT = 0x8B9B;
        public static int COMPILE_STATUS = 0x8B81;
        public static int INFO_LOG_LENGTH = 0x8B84;
        public static int SHADER_SOURCE_LENGTH = 0x8B88;
        public static int SHADER_COMPILER = 0x8DFA;
