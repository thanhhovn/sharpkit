...
namespace Ext.button
{
    ...
    public partial class Button : Ext.Component, Ext.util.Floating, Ext.util.Observable, Ext.util.Animate, Ext.state.Stateful
    {
        ...
        /// </summary>
        public object getPressed(JsString group){return null;}
        /// <summary>
    ...
    public partial class ButtonConfig : Ext.ComponentConfig
    {
        ...
        public new JsString cls{get;set;}
        ...
        /// </summary>
        public new JsString overCls{get;set;}
        /// <summary>
