...
{
    /// <summary>
	/// <para>This class provides capture event support at DOM level.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Capture", OmitOptionalParameters = true, Export = false)]
    public partial class Capture : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods

		public Capture() { throw new NotImplementedException(); }
