...
{
    /// <summary>
	/// <para>This class provides qooxdoo object event support.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Object", OmitOptionalParameters = true, Export = false)]
    public partial class Object : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
