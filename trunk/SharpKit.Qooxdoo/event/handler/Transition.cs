...
namespace qx.eventx.handler
{
	...
	/// <para>This class provides support for HTML5 transition and animation events.
	/// Currently only WebKit and Firefox are supported.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Transition", OmitOptionalParameters = true, Export = false)]
    public partial class Transition : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
		...
		public Transition(qx.eventx.Manager manager) { throw new NotImplementedException(); }
