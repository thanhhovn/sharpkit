...
namespace qx.eventx.handler
{
	...
	/// <para>This class provides a handler for the orientation event.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Orientation", OmitOptionalParameters = true, Export = false)]
    public partial class Orientation : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
		...
		public Orientation(qx.eventx.Manager manager) { throw new NotImplementedException(); }
