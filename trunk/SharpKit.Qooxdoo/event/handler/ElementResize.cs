...
{
    /// <summary>
	/// <para>This handler fires a resize event if the size of a DOM element
	/// changes.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.ElementResize", OmitOptionalParameters = true, Export = false)]
    public partial class ElementResize : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods

		public ElementResize() { throw new NotImplementedException(); }

		/// <param name="manager">Event manager for the window to use</param>
		public ElementResize(qx.eventx.Manager manager) { throw new NotImplementedException(); }
