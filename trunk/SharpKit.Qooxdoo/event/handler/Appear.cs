...
{
    /// <summary>
	/// <para>This class supports appear and disappear events
	/// on DOM level.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Appear", OmitOptionalParameters = true, Export = false)]
    public partial class Appear : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods

		public Appear() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Create a new instance</para>
		/// </summary>
		/// <param name="manager">Event manager for the window to use</param>
		public Appear(qx.eventx.Manager manager) { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Refreshes all appear handlers. Useful after massive DOM manipulations e.g.
		/// through qx.html.Element.</para>
		/// </summary>
		...
		/// <summary>
		/// <para>This method should be called by all DOM tree modifying routines
		/// to check the registered nodes for changes.</para>
		/// </summary>
		[JsMethod(Name = "refresh")]
