...
{
    /// <summary>
	/// <para>This handler accepts the useraction event fired by the keyboard and
	/// and mouse handlers after an user triggered action has occurred.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.UserAction", OmitOptionalParameters = true, Export = false)]
    public partial class UserAction : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods

		public UserAction() { throw new NotImplementedException(); }
