...
{
    /// <summary>
	/// <para>This handler provides event for the window object.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Window", OmitOptionalParameters = true, Export = false)]
    public partial class Window : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
		...
		public Window(qx.eventx.Manager manager) { throw new NotImplementedException(); }
