...
{
    /// <summary>
	/// <para>Log appender for qooxdoo applications running in Mozilla Rhino. Writes log
	/// messages to a text file.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.log.appender.RhinoFile", OmitOptionalParameters = true, Export = false)]
    public partial class RhinoFile 
    {
		#region Methods

		public RhinoFile() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Creates a new log file using the value of <see cref="#FILENAME"/> as the
		/// file path/name.</para>
		/// </summary>
		[JsMethod(Name = "create")]
		public static void Create() { throw new NotImplementedException(); }
		...
		/// <summary>
		/// <para>Writes a message to the file.</para>
		/// </summary>
		/// <param name="logMessage">Message to be logged</param>
