...
{
    /// <summary>
	/// <para>Popups are widgets, which can be placed on top of the application.
	/// They are automatically added to the application root.</para>
	/// <para>Popups are used to display menus, the lists of combo or select boxes,
	/// tooltips, etc.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.popup.Popup", OmitOptionalParameters = true, Export = false)]
    public partial class Popup : qx.ui.container.Composite
    {
		#region Properties
		...
		public Popup(object layout) { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Returns the (computed) value of the property autoHide.</para>
		/// </summary>
		[JsMethod(Name = "getAutoHide")]
		public bool GetAutoHide() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Calls the apply method and dispatches the change event of the property autoHide
		/// with the default value defined by the class developer. This function can
		/// only be called from the constructor of a class.</para>
		/// </summary>
		/// <param name="value">Initial value for property autoHide.</param>
		[JsMethod(Name = "initAutoHide")]
		public void InitAutoHide(object value) { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Check whether the (computed) value of the boolean property autoHide equals true.</para>
		/// </summary>
		[JsMethod(Name = "isAutoHide")]
		public void IsAutoHide() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Resets the user value of the property autoHide.</para>
		/// <para>The computed value falls back to the next available value e.g. appearance, init or
		/// inheritance value depeneding on the property configuration and value availability.</para>
		/// </summary>
		[JsMethod(Name = "resetAutoHide")]
		public void ResetAutoHide() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Sets the user value of the property autoHide.</para>
		/// </summary>
		/// <param name="value">New value for property autoHide.</param>
		...
		/// <summary>
		/// <para>Toggles the (computed) value of the boolean property autoHide.</para>
		/// </summary>
		[JsMethod(Name = "toggleAutoHide")]
		public void ToggleAutoHide() { throw new NotImplementedException(); }
