...
namespace qx.ui.layout
{
	...
	/// <para>The vertical box layout lays out widgets in a vertical column, from top
	/// to bottom.</para>
	/// <para>Features</para>
	/// <list type="bullet">
	/// <item>Minimum and maximum dimensions</item>
	/// <item>Prioritized growing/shrinking (flex)</item>
	/// <item>Margins (with vertical collapsing)</item>
	/// <item>Auto sizing (ignoring percent values)</item>
	/// <item>Percent heights (not relevant for size hint)</item>
	/// <item>Alignment (child property <see cref="qx.ui.core.LayoutItem.AlignY"/> is ignored)</item>
	...
	/// flex value to zero.
	/// </item>
	/// <item>height (String): Allows to define a percent
	...
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.layout.VBox", OmitOptionalParameters = true, Export = false)]
    public partial class VBox : qx.ui.layout.Abstract
    {
		#region Properties

		/// <summary>
		/// <para>Horizontal alignment of each child. Can be overridden through
		...
		/// <summary>
		/// <para>Vertical alignment of the whole children block. The vertical
		...
		/// <param name="alignY">Vertical alignment of the whole children block #alignY.</param>
		/// <param name="separator">A separator to render between the items</param>
		public VBox(double spacing = 0, string alignY = "top", qx.html.Decorator separator = null) { throw new NotImplementedException(); }
