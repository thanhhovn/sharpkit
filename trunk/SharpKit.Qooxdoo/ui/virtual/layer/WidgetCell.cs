...
namespace qx.ui.virtualx.layer
{
	...
	/// <para>The WidgetCell layer renders each cell with a qooxdoo widget. The concrete
	/// widget instance for each cell is provided by a cell provider.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.virtual.layer.WidgetCell", OmitOptionalParameters = true, Export = false)]
    public partial class WidgetCell : qx.ui.virtualx.layer.Abstract
    {
		#region Events
