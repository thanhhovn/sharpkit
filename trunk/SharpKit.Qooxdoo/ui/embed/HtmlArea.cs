...
{
    /// <summary>
	/// <para>Rich text editor widget which encapsulates the low-level <see cref="qx.bom.htmlarea.HtmlArea"/>
	/// component to offer editing features.</para>
	/// <para>Optimized for the use at a RIA.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.embed.HtmlArea", OmitOptionalParameters = true, Export = false)]
    public partial class HtmlArea : qx.ui.core.Widget
    {
		#region Events
		...
		public HtmlArea(string value, object styleInformation, string source) { throw new NotImplementedException(); }
		...
		/// <summary>
		/// <para>Helper function to examine if HTMLArea is empty, except for
		/// place holder(s) needed by some browsers.</para>
		/// </summary>
		/// <returns>True, if area is empty &#8211; otherwise false.</returns>
		[JsMethod(Name = "containsOnlyPlaceholder")]
		public bool ContainsOnlyPlaceholder() { throw new NotImplementedException(); }

		[JsMethod(Name = "focus")]
		public void Focus() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Forces the htmlArea to reset the document editable. This method can
		/// be useful (especially for Gecko) whenever the HtmlArea was hidden and
		/// gets visible again.</para>
		/// </summary>
		[JsMethod(Name = "forceEditable")]
		public void ForceEditable() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Getter for command manager.</para>
		/// </summary>
		/// <returns>manager instance or null if the editor is not initialized</returns>
		...
		/// </summary>
		/// <returns>complete content or null if the editor is not initialized</returns>
		...
		/// <returns>computed value of the editor or null if the editor is not initialized</returns>
		...
		public object GetContentWindow() { throw new NotImplementedException(); }
		...
		/// </summary>
		/// <returns>formatting information about the focusNode or null if not initialized</returns>
		...
		/// </summary>
		/// <returns>focus node or null if not initialized</returns>
		[JsMethod(Name = "getFocusNode")]
		public Node GetFocusNode() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Get html content (call own recursive method)</para>
		/// </summary>
		/// <param name="skipHtmlEncoding">whether the html encoding of text nodes should be skipped</param>
		/// <returns>current content of the editor as XHTML or null if not initialized</returns>
		...
		/// </summary>
		/// <returns>iframe DOM element or null if the editor is not initialized</returns>
		[JsMethod(Name = "getIframeObject")]
		public Iframe GetIframeObject() { throw new NotImplementedException(); }
		...
		/// </summary>
		/// <returns>Range object or null if not initialized</returns>
		...
		/// </summary>
		/// <returns>selected text or null if not initialized</returns>
		[JsMethod(Name = "getSelectedHtml")]
		public string GetSelectedHtml() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Returns the currently selected text.</para>
		/// </summary>
		/// <returns>Selected plain text or null if not initialized.</returns>
		[JsMethod(Name = "getSelectedText")]
		public string GetSelectedText() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Returns the current selection object</para>
		/// </summary>
		/// <returns>Selection object or null if not initialized.</returns>
		...
		/// method instead.</para>
		/// </summary>
		/// <returns>value of the editor or null if it&#8217;s not initialized</returns>
		...
		/// </summary>
		/// <returns>true if the redo command was executed successfully</returns>
		[JsMethod(Name = "redo")]
		...
		/// <summary>
		/// <para>Safes the current range to let the next command operate on this range.
		...
		/// <para>Whether the document is in editable mode</para>
		/// </summary>
		/// <param name="value">whether the component should be editable</param>
		...
		/// <summary>
		/// <para>Setting the value of the editor if it&#8217;s initialized</para>
		/// </summary>
		...
		/// </summary>
		/// <returns>true if the undo command was executed successfully</returns>
		[JsMethod(Name = "undo")]
