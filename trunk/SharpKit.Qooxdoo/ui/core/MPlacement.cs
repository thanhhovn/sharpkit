...
{
    /// <summary>
	/// <para>Methods to place popup like widgets to other widgets, points,
	/// mouse event coordinates, etc.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.core.MPlacement", OmitOptionalParameters = true, Export = false)]
    public partial class MPlacement 
    {
		#region Properties
		...
		public MPlacement() { throw new NotImplementedException(); }
