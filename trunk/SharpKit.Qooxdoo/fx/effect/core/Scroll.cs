...
namespace qx.fx.effect.core
{
	...
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.fx.effect.core.Scroll", OmitOptionalParameters = true, Export = false)]
    public partial class Scroll : qx.fx.Base
    {
		#region Properties

		/// <summary>
		/// <para>String indicating if the coordinates are relative or absolute.</para>
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// <para>X coordinate the element should be scroll to.</para>
		/// </summary>
		[JsProperty(Name = "x", NativeField = true)]
		public double X { get; set; }

		/// <summary>
		/// <para>Y coordinate the element should be scroll to.</para>
		/// </summary>
