...
{
    /// <summary>
	/// <para>Places the object directly at the specified position. It is not moved if
	/// parts of the object are outside of the axis&#8217; range.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.util.placement.DirectAxis", OmitOptionalParameters = true, Export = false)]
    public partial class DirectAxis 
    {
		#region Methods

		public DirectAxis() { throw new NotImplementedException(); }
