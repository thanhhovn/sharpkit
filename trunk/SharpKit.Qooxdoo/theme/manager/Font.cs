...
{
    /// <summary>
	/// <para>Manager for font themes</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.theme.manager.Font", OmitOptionalParameters = true, Export = false)]
    public partial class Font : qx.util.ValueManager
    {
		#region Events
		...
		/// <summary>
		/// <para>the currently selected font theme</para>
		/// </summary>
		/// <remarks>
		/// Allow nulls: true
		/// </remarks>
		...
		public static qx.theme.manager.Font GetInstance() { throw new NotImplementedException(); }
