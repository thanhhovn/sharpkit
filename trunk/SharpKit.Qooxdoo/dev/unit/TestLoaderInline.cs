...
namespace qx.dev.unit
{
	...
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.dev.unit.TestLoaderInline", OmitOptionalParameters = true, Export = false)]
    public partial class TestLoaderInline : qx.application.Inline
    {
		#region Properties
