...
namespace SenchaTouchSamples.examples.getting_started
{
    ...
    public class App
    {
        static void OnReady()
        {
            ...
            new Application(new ApplicationConfig
            {
                name = "Sencha",

                //launch = () => Viewport.add(new {xtype = "tabpanel", fullscreen = true, tabBarPosition = "bottom"
                //items = new JsArray {new { 
                //}),
