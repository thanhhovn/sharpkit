...
var ClrModeSamples$MyApp=
{
    ...
    staticDefinition:
    {
        Main:function()
        {
            var list=new System.Collections.Generic.List$1.ctor(ClrModeSamples.Contact.ctor);
            list.Add((function()
            {
            ...
            System.Linq.Enumerable.First$1$$IEnumerable$1(ClrModeSamples.Contact.ctor,list).CallMe();
            System.Linq.Enumerable.First$1$$IEnumerable$1(ClrModeSamples.Contact.ctor,list).CallMe$$String("Hello");
        }
    },
