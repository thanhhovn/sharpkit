...
public partial class WebGLRenderingContext
{
	...
	public string getShaderInfoLog(WebGLShader shader) { return default(string); }
	public string getShaderSource(WebGLShader shader) { return default(string); }
	public string getString(int name) { return default(string); }
