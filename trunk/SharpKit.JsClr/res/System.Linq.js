...
var System$Linq$Enumerable=
{
    ...
    staticDefinition:
    {
        ...
        First$1$$IEnumerable$1$$Func$2:function(TSource,source,predicate)
        {
            ...
            if(System.MulticastDelegate.op_Equality$$MulticastDelegate$$MulticastDelegate(predicate,null))
            {
        ...
        Where$1$$IEnumerable$1$$Func$2:function(TSource,source,predicate)
        {
            ...
            if(Is(source,System.Linq.Enumerable.Iterator))
            {
                return (Cast(source,System.Linq.Enumerable.Iterator)).Where(predicate);
            }
            if(Is(source,Array))
            {
                return new System.Linq.Enumerable.WhereArrayIterator.ctor(TSource,Cast(source,Array),predicate);
            }
            if(Is(source,System.Collections.Generic.List$1))
            {
                return new System.Linq.Enumerable.WhereListIterator.ctor(TSource,Cast(source,System.Collections.Generic.List$1),predicate);
            }
        ...
        Select$2$$IEnumerable$1$$Func$2:function(TSource,TResult,source,selector)
        {
            ...
            if(System.MulticastDelegate.op_Equality$$MulticastDelegate$$MulticastDelegate(selector,null))
            {
                throw $CreateException(System.Linq.Error.ArgumentNull("selector"),new Error());
            }
            if(Is(source,System.Linq.Enumerable.Iterator))
            {
                return (Cast(source,System.Linq.Enumerable.Iterator)).Select$1(TResult,selector);
            }
            if(Is(source,Array))
            {
            ...
            if(Is(source,System.Collections.Generic.List$1))
            {
                return new System.Linq.Enumerable.WhereSelectListIterator.ctor(TSource,TResult,Cast(source,System.Collections.Generic.List$1),null,selector);
            }
        ...
        MoveNext:function()
        {
            if(this.state == 1)
            {
                while(this.index < this.source.length)
                {
                    ...
                    this.index++;
                    if(System.MulticastDelegate.op_Equality$$MulticastDelegate$$MulticastDelegate(this.predicate,null) || this.predicate(arg))
                    {
...
var System$Linq$Enumerable$WhereSelectEnumerableIterator=
{
    ...
    definition:
    {
        ...
        MoveNext:function()
        {
            ...
            {
                var current=this.enumerator.get_Current();
                if(System.MulticastDelegate.op_Equality$$MulticastDelegate$$MulticastDelegate(this.predicate,null) || this.predicate(current))
                {
