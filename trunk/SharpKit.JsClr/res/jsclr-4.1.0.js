    ...
    definition:
    {
        ...
        VerifyMethods:function()
        {
            if(this._MethodsByName == null)
            {
                ...
                if(baseType != null)
                {
                    ...
                    for(var $i12=0,$l12=methods.length,pe=methods[$i12];$i12 < $l12;$i12++,pe = methods[$i12])
                    {
        ...
        GetAttributeTarget:function(memberType,memberName)
        {
            ...
            else if(memberType == "method")
            {
                ...
                for(var $i13=0,$l13=methods.length,method=methods[$i13];$i13 < $l13;$i13++,method = methods[$i13])
                {
...
var SharpKit$JavaScript$JsNamingHelper=
{
    ...
    staticDefinition:
    {
        ...
        {
            for(var $i15=0,$l15=prms.length,prm=prms[$i15];$i15 < $l15;$i15++,prm = prms[$i15])
            {
                sb.Append$$String("$$");
