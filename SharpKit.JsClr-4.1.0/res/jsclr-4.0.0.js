...
//@Merged Compilation/JsCompiler.js
//@AutoGenerated
if(typeof($CreateDelegate)=='undefined'){var $fki=0;var $fkp=String.fromCharCode(1);$CreateDelegate=function(a,b){if(a==null) return b;var c=a.$delegateCache;if(c==null){c={};a.$delegateCache=c;}if(b.$fk==null) {$fki++;b.$fk=$fkp+String($fki);}var d=c[b.$fk];if(d==null){ d=function(){return arguments.callee.func.apply(arguments.callee.target, arguments);};d.func=b;d.target=a;d.isDelegate=true;c[b.$fk]=d;}return d;}}
JsCompiler = function()
{
...
AfterCompilation($CreateDelegate(this, function(){
...
//@MergedEOF Compilation/JsCompiler.js
		...
		function(value)
{
    this.date.setMilliseconds(value);
		...
		"System.Int32",get_DayOfWeek : 
		function()
{
    return this.date.getDay();
},Today$$ : 
		"SharpKit.JavaScript.Private.JsImplDateTime",get_Today : 
		function()
{
		...
		function(months)
{
	...
	staticDefinition : {
		Now$$ : 
		"SharpKit.JavaScript.Private.JsImplDateTime",get_Now : 
		function()
{
		...
		function(args)
{
	...
	,
	staticDefinition : {
		Combine$$Delegate$Array : 
		function(delegates)
{
    throw new System.NotImplementedException.ctor();
},Combine$$Delegate$$Delegate : 
		function(delegate1, delegate2)
{
...
JsTypes.push(
{
	...
	definition : {
		ctor : 
		function(T1, T2, TResult, obj, func)
{
    this.T1 = T1;
    this.T2 = T2;
    this.TResult = TResult;
...
JsTypes.push(
{
	...
	definition : {
		ctor : 
		function(T1, T2, T3, TResult, obj, func)
{
    this.T1 = T1;
    this.T2 = T2;
    this.T3 = T3;
		...
		function(paramName, actualValue, message)
{
    ...
    System.Exception.commonPrototype.SetErrorCode.call(this, -2146233086);
		...
		"System.Object",get_ActualValue : 
		function()
{
    return this.m_actualValue;
},RangeMessage$$ : 
		"System.String",get_RangeMessage : 
		function()
{
...
JsTypes.push(
{
	...
	staticDefinition : {
		...
		"InvariantCultureIgnoreCase",Ordinal : 
...
MAX_DIRECTORY_PATH:MAX_PATH:if(typeof(JsTypes)=='undefined')  JsTypes = [];
JsTypes.push(
{
	isEnum : false,
	definition : {
...
},CharArrayStartsWithOrdinal : 
		function(array, numChars, compareTo, ignoreCase)
{
		...
		function(path, fullCheck)
{
    return path;
		...
		['"', '<', '>', '|', '\0', '\x0001', '\x0002', '\x0003', '\x0004', '\x0005', '\x0006', '\a', '\b', '\t', '\n', '\v', '\f', '\r', '\x000e', '\x000f', '\x0010', '\x0011', '\x0012', '\x0013', '\x0014', '\x0015', '\x0016', '\x0017', '\x0018', '\x0019', '\x001a', '\x001b', '\x001c', '\x001d', '\x001e', '\x001f', ':', '*', '?', '\\', '/'],InvalidPathChars : 
		['"', '<', '>', '|', '\0', '\x0001', '\x0002', '\x0003', '\x0004', '\x0005', '\x0006', '\a', '\b', '\t', '\n', '\v', '\f', '\r', '\x000e', '\x000f', '\x0010', '\x0011', '\x0012', '\x0013', '\x0014', '\x0015', '\x0016', '\x0017', '\x0018', '\x0019', '\x001a', '\x001b', '\x001c', '\x001d', '\x001e', '\x001f'],MaxPath : 
		260,PathSeparator : 
		';',RealInvalidPathChars : 
		['"', '<', '>', '|', '\0', '\x0001', '\x0002', '\x0003', '\x0004', '\x0005', '\x0006', '\a', '\b', '\t', '\n', '\v', '\f', '\r', '\x000e', '\x000f', '\x0010', '\x0011', '\x0012', '\x0013', '\x0014', '\x0015', '\x0016', '\x0017', '\x0018', '\x0019', '\x001a', '\x001b', '\x001c', '\x001d', '\x001e', '\x001f'],VolumeSeparatorChar : 
		':'}
	,
	baseType : null,
	customAttributes : [],
...
},FirstOrDefault$$IEnumerable$1$$Func$2 : 
		function(TSource, source, predicate)
{
    if (source == null)
    {
		...
		function(TSource, source)
{
    ...
    return Default(TSource);
},LastOrDefault$$IEnumerable$1$$Func$2 : 
		function(TSource, source, predicate)
{
    if (source == null)
    {
		...
		function(TSource, source, predicate)
{
    ...
    throw new System.NotImplementedException.ctor();
},Contains$$IEnumerable$1$$TSource : 
...
},Contains$$IEnumerable$1$$TSource$$IEqualityComparer$1 : 
		...
		function(TKey, TValue)
{
    ...
    this._version = 0;
		...
		"System.Collections.Generic.ICollection`1",get_Keys : 
		function()
{
    var keys = new Array();
    ...
    return keys;
		...
		"System.Collections.Generic.ICollection`1",get_Values : 
		function()
{
...
JsTypes.push(
{
	...
	staticDefinition : {
		CreateInstance : 
		"CreateInstance",DeclaredOnly : 
		"DeclaredOnly",Default : 
		"Default",ExactBinding : 
		"ExactBinding",FlattenHierarchy : 
		"FlattenHierarchy",GetField : 
		"GetField",GetProperty : 
		"GetProperty",IgnoreCase : 
		"IgnoreCase",IgnoreReturn : 
		"IgnoreReturn",Instance : 
		"Instance",InvokeMethod : 
		"InvokeMethod",NonPublic : 
		"NonPublic",OptionalParamBinding : 
		"OptionalParamBinding",Public : 
		"Public",PutDispProperty : 
		"PutDispProperty",PutRefDispProperty : 
		"PutRefDispProperty",SetField : 
		...
		function()
{
    return this._Name;
		...
		"SharpKit.JavaScript.Private.JsImplType",get_DeclaringType : 
		function()
{
		...
		function()
{
    return null;
		...
		function(list, attributeType, inherit)
{
    ...
    if (inherit)
    {
		...
		function(attributeType, inherit)
{
		...
		function()
{
    return this._Name;
		...
		"SharpKit.JavaScript.Private.JsImplType",get_PropertyType : 
		function()
{
		...
		function()
{
    return this._JsType.isEnum;
		...
		"SharpKit.JavaScript.Private.JsImplType",get_BaseType : 
		function()
{
		...
		function(def)
{
    for(var funcName in def)
    {
		...
		function(def, funcName, isSetter)
{
		...
		function()
{
    ...
    for (var i = 0;i < this._JsType.customAttributes.length;i++)
    {
		...
		function(memberType, memberName)
{
    if (memberType == "type")
        return this;
		...
		function(name, throwOnError)
{
    ...
    return System.Type._TypeOf(jsType);
		...
		function(name, throwOnError, ignoreCase)
{
    if (ignoreCase)
        throw new System.NotImplementedException.ctor();
