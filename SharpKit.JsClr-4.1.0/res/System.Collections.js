...
{System.Collections.Generic.List$1.ctor.call(this,"System.Object");}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:[],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Collections.ArrayList",baseTypeName:"System.Collections.Generic.List$1",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function(TKey,TValue)
{this.TKey=TKey;this.TValue=TValue;this._table=null;this._keys=null;this._version=0;System.Object.ctor.call(this);this._table=new Object();this._keys=new Object();this._version=0;},Keys$$:"System.Collections.Generic.ICollection`1",get_Keys:function()
...
{return SharpKit.JavaScript.Utils.Js.GetHashKey(key);},Add:function(key,value)
{var hashKey=this.GetHashKey(key);this._table[hashKey]=value;this._keys[hashKey]=key;this._version++;},Remove:function(key)
{var hashKey=this.GetHashKey(key);delete(this._table[hashKey]);delete(this._keys[hashKey]);this._version++;return true;},ContainsKey:function(key)
...
{throw new System.NotImplementedException.ctor();}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:["System.Collections.Generic.IDictionary$2"],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Collections.Generic.Dictionary$2",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function(T)
{this.T=T;this._list=null;System.Object.ctor.call(this);this._list=new Array();},Count$$:"System.Int32",get_Count:function()
...
{return this._list.contains(item);}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:["System.Collections.Generic.IEnumerable$1","System.Collections.ICollection"],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Collections.Generic.Stack$1",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function(T,list)
{this.T=T;this.List=null;this.Index=0;this.ListCount=0;System.Object.ctor.call(this);this.List=list;this.Index=-1;this.ListCount=list.get_Count();},Current$$:"T",get_Current:function()
...
{this.Index=-1;}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:["System.Collections.Generic.IEnumerator$1"],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Collections.IListEnumerator$1",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})
if(typeof(JsTypes)=='undefined')JsTypes=[];JsTypes.push({isEnum:false,definition:{ctor:function(T)
{this.T=T;this._list=null;System.Object.ctor.call(this);this._list=new Array();},ctor$$IEnumerable$1:function(T,collection)
{this.T=T;this._list=null;System.Object.ctor.call(this);this._list=new Array();this.AddRange(collection);},Count$$:"System.Int32",get_Count:function()
...
{this._list.sort(SharpKit.JavaScript.Utils.Js.ToJsFunction(comparison));}},staticDefinition:{},baseType:null,customAttributes:[],interfaceNames:["System.Collections.Generic.IList$1","System.Collections.IList"],assemblyName:"SharpKit.JsClr-4.1.0",fullname:"System.Collections.Generic.List$1",baseTypeName:"System.Object",isInterface:false,isDelegate:false,isValueType:false,isPartial:false})