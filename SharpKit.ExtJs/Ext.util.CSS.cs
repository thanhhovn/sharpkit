...
namespace Ext.util
{
    ...
    /// <inheritdocs />
    /// <summary>
    /// <p>Utility class for manipulating CSS rules</p>
    /// </summary>
    ...
    public partial class CSS : Ext.Base
    {
        ...
        /// </summary>
        /// <param name="cssText"><p>The text containing the css rules</p>
        /// </param>
        /// <param name="id"><p>An id to add to the stylesheet for later removal</p>
        /// </param>
        /// <returns>
        /// <span>CSSStyleSheet</span><div>
        /// </div>
        /// </returns>
        public static JsObject createStyleSheet(JsString cssText, JsString id){return null;}
        /// <summary>
        ...
        /// </summary>
        /// <param name="selector"><p>The CSS selector or an array of selectors to try. The first selector that is found is returned.</p>
        /// </param>
        /// <param name="refreshCache"><p>true to refresh the internal cache if you have recently updated any rules or added styles dynamically</p>
        /// </param>
        /// <returns>
        /// <span>CSSStyleRule</span><div><p>The CSS rule or null if one is not found</p>
        /// </div>
        /// </returns>
        public static JsObject getRule(object selector, bool refreshCache){return null;}
        /// <summary>
        /// Gets all css rules for the document
        /// </summary>
        /// <param name="refreshCache"><p>true to refresh the internal cache</p>
        /// </param>
        /// <returns>
        /// <span><see cref="Object">Object</see></span><div><p>An object (hash) of rules indexed by selector</p>
        /// </div>
        /// </returns>
        ...
        /// </summary>
        /// <param name="id"><p>The id of the tag</p>
        /// </param>
        public static void removeStyleSheet(JsString id){}
        /// <summary>
        /// Parameters<li><span>config</span> : <see cref="Object">Object</see><div>
        ...
        /// </summary>
        /// <param name="id"><p>The id of an existing link tag to remove</p>
        /// </param>
        /// <param name="url"><p>The href of the new stylesheet to include</p>
        /// </param>
        public static void swapStyleSheet(JsString id, JsString url){}
        /// <summary>
        /// Updates a rule property
        /// </summary>
        /// <param name="selector"><p>If it's an array it tries each selector until it finds one. Stops immediately once one is found.</p>
        /// </param>
        /// <param name="property"><p>The css property</p>
        /// </param>
        /// <param name="value"><p>The new value for the property</p>
        /// </param>
        /// <returns>
        /// <span><see cref="bool">Boolean</see></span><div><p>true If a rule was found and updated</p>
        /// </div>
        /// </returns>
        public static bool updateRule(object selector, JsString property, JsString value){return false;}
        public CSS(CSSConfig config){}
        public CSS(){}
        public CSS(params object[] args){}
    }
    #endregion
    #region CSSConfig
    /// <inheritdocs />
    ...
    {
        public CSSConfig(params object[] args){}
    }
    #endregion
    #region CSSEvents
    /// <inheritdocs />
    ...
    {
        public CSSEvents(params object[] args){}
    }
    #endregion
}
