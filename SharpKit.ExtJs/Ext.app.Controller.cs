...
namespace Ext.app
{
    ...
    /// <pre><code><see cref="Ext.ExtContext.define">Ext.define</see>('MyApp.controller.Users', {
    ...
    /// <see cref="Ext.app.Application">Application</see>'s launch function is executed so gives a hook point to run any code before
    ...
    /// conjunction with another Controller function - <see cref="Ext.app.Controller.control">control</see>. The control function
    ...
    /// are not familiar with ComponentQuery yet, be sure to check out the <see cref="Ext.ComponentQuery">documentation</see>. In brief though,
    ...
    /// <h2>Using refs</h2>
    /// <p>One of the most useful parts of Controllers is the new ref system. These use the new <see cref="Ext.ComponentQuery">Ext.ComponentQuery</see> to
    ...
    /// });
    /// </code></pre>
    /// <p>This example assumes the existence of a <see cref="Ext.grid.Panel">Grid</see> on the page, which contains a single button to
    /// refresh the Grid when clicked. In our refs array, we set up a reference to the grid. There are two parts to this -
    /// the 'selector', which is a <see cref="Ext.ComponentQuery">ComponentQuery</see> selector which finds any grid on the page and
    ...
    /// to listen to any click on a <see cref="Ext.button.Button">button</see> and call our refreshGrid function (again, this will
    ...
    /// <i>application architecture guide</i>. Also see the <see cref="Ext.app.Application">Ext.app.Application</see> documentation.</p>
    /// </summary>
    ...
    public partial class Controller : Ext.Base, Ext.util.Observable
    {
        ...
        /// <code><see cref="Ext.ExtContext.define">Ext.define</see>("MyApp.controller.Foo", {
        /// extend: "<see cref="Ext.app.Controller">Ext.app.Controller</see>",
        /// models: ['User', 'Vehicle']
        /// });
        /// </code>
        ...
        /// });
        /// </code>
        /// This will add method <c>getList</c> to the controller which will internally use
        /// <see cref="Ext.ComponentQuery">Ext.ComponentQuery</see> to reference the grid component on page.
        /// The following fields can be used in ref definition:
        /// <li><c>ref</c> - name of the reference.</li>
        /// <li><c>selector</c> - <see cref="Ext.ComponentQuery">Ext.ComponentQuery</see> selector to access the component.</li>
        /// <li><c>autoCreate</c> - True to create the component automatically if not found on page.</li>
        /// <li><c>forceCreate</c> - Forces the creation of the component every time reference is accessed
        /// (when <c>get&lt;REFNAME&gt;</c> is called).</li>
        /// </summary>
        ...
        /// In the following example the <c>updateUser</c> function is mapped to to the <c>click</c>
        /// event on a button component, which is a child of the <c>useredit</c> component.
        /// <code><see cref="Ext.ExtContext.define">Ext.define</see>('AM.controller.Users', {
        /// init: function() {
        /// this.control({
        ...
        /// });
        /// </code>
        /// See <see cref="Ext.ComponentQuery">Ext.ComponentQuery</see> for more information on component selectors.
        /// </summary>
        /// <param name="selectors"><p>If a String, the second argument is used as the
        ...
        /// </param>
        /// <returns>
        /// <span><see cref="Ext.app.Controller">Ext.app.Controller</see></span><div><p>a controller instance.</p>
        /// </div>
        /// </returns>
        public Controller getController(JsString name){return null;}
        /// <summary>
        ...
        /// </div>
        /// </returns>
        public Ext.data.Model getModel(JsString name){return null;}
        /// <summary>
        ...
        /// </param>
        /// <returns>
        /// <span><see cref="Ext.data.Store">Ext.data.Store</see></span><div><p>a store instance.</p>
        /// </div>
        /// </returns>
        public Ext.data.Store getStore(JsString name){return null;}
        /// <summary>
        /// Returns a View class with the given name.  To create an instance of the view,
        /// you can use it like it's used by Application to create the Viewport:
        /// <code>this.getView('Viewport').create();
        /// </code>
        /// </summary>
        /// <param name="name">
        /// </param>
        /// <returns>
        /// <span><see cref="Ext.Base">Ext.Base</see></span><div><p>a view class.</p>
        /// </div>
        /// </returns>
        public Ext.Base getView(JsString name){return null;}
        /// <summary>
        ...
        /// </div>
        /// </returns>
        public bool hasRef(object @ref){return false;}
        /// <summary>
    ...
    public partial class ControllerConfig : Ext.BaseConfig
    {
        ...
        /// </summary>
        public JsString views;
        public ControllerConfig(params object[] args){}
    }
    #endregion
    ...
    {
        public ControllerEvents(params object[] args){}
    }
    #endregion
}
