...
namespace Ext.fx
{
    ...
    /// <p>The <see cref="Ext.fx.AnimatorConfig.keyframes">keyframes</see> option is the most important part of specifying an animation when using this
    ...
    /// you <em>must</em> specify the values at 0% and 100%, the start and ending values. There is also a <see cref="Ext.fx.AnimatorEvents.keyframe">keyframe</see>
    ...
    /// <pre><code><see cref="Ext.ExtContext.create">Ext.create</see>('<see cref="Ext.fx.Animator">Ext.fx.Animator</see>', {
    /// target: <see cref="Ext.ExtContext.getBody">Ext.getBody</see>().createChild({
    /// style: {
    /// width: '100px',
    /// height: '100px',
    ...
    public partial class Animator : Ext.Base, Ext.util.Observable
    {
        ...
        /// </summary>
        public Ext.fx.target.Target target;
        /// <summary>
        /// Defaults to: <c>/^(from|to|\d+%?)$/</c>
        /// </summary>
        private JsRegExp animKeyFramesRE{get;set;}
        /// <summary>
        /// Applies animation to the Ext.fx.target
        /// </summary>
        private object applyAnimator{get;set;}
        /// <summary>
        ...
        /// </summary>
        public bool isAnimator{get;set;}
        /// <summary>
        ...
        /// </param>
        private void createTimeline(object keyframes){}
        /// <summary>
        ...
        /// <summary>
        /// Parameters<li><span>a</span> : <see cref="Object">Object</see><div>
        /// </div></li><li><span>b</span> : <see cref="Object">Object</see><div>
        /// </div></li>
        /// </summary>
        /// <param name="a">
        /// </param>
        /// <param name="b">
        /// </param>
        private void sorter(object a, object b){}
        /// <summary>
        ...
        public Animator(AnimatorConfig config){}
        public Animator(){}
    ...
    public partial class AnimatorConfig : Ext.BaseConfig
    {
        /// <summary>
        /// Time to delay before starting the animation. Defaults to 0.
        /// Defaults to: <c>0</c>
        ...
        /// </summary>
        public Ext.fx.target.Target target;
        public AnimatorConfig(params object[] args){}
    }
    #endregion
    #region AnimatorEvents
    /// <inheritdocs />
    [JsType(JsMode.Json, Export=false, OmitOptionalParameters=true)]
    public partial class AnimatorEvents : Ext.BaseEvents
    {
        /// <summary>
        ...
        /// </param>
        public void afteranimate(Animator @this, JsDate startTime, object eOpts){}
        /// <summary>
        ...
        /// <param name="eOpts"><p>The options object passed to <see cref="Ext.util.Observable.addListener">Ext.util.Observable.addListener</see>.</p>
        /// </param>
        public void beforeanimate(Animator @this, object eOpts){}
        /// <summary>
        /// Fires at each keyframe.
        /// </summary>
        /// <param name="this">
        /// </param>
        /// <param name="keyframe"><p>step number</p>
        /// </param>
        /// <param name="eOpts"><p>The options object passed to <see cref="Ext.util.Observable.addListener">Ext.util.Observable.addListener</see>.</p>
        /// </param>
        public void keyframe(Animator @this, JsNumber keyframe, object eOpts){}
        public AnimatorEvents(params object[] args){}
    }
    #endregion
}
