...
namespace YUI_
{
    ...
    public partial class CartesianSeries
    {
        ...
        /// </summary>
        protected object _getDefaultColor(YUI_.DataType_.Number index, object type){return null;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.DataType_.Number getTotalValues(){return null;}
        /// <summary>
        ...
        /// </summary>
        protected YUI_.Array _defaultBorderColors{get;set;}
        /// <summary>
        /// Collection of default colors used for marker fills in a series when not specified by user.
        /// </summary>
        protected YUI_.Array _defaultFillColors{get;set;}
        /// <summary>
        /// Collection of default colors used for lines in a series when not specified by user.
        /// </summary>
        protected YUI_.Array _defaultLineColors{get;set;}
        /// <summary>
        /// Collection of default colors used for area fills, histogram fills and pie fills in a series when not specified by user.
        /// </summary>
        protected YUI_.Array _defaultSliceColors{get;set;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.DataType_.Number graphOrder{get;set;}
        /// <summary>
        /// Returns the height of the parent graph
        /// </summary>
        public YUI_.DataType_.Number height{get;set;}
        /// <summary>
        /// Order of this instance of this `type`.
        /// </summary>
        public YUI_.DataType_.Number order{get;set;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.Array xcoords{get;set;}
        /// <summary>
        /// Array of x values for the series.
        /// </summary>
        public YUI_.Array xData{get;set;}
        /// <summary>
        /// Collection of area maps along the xAxis. Used to determine mouseover for multiple
        /// series.
        /// </summary>
        public YUI_.Array xMarkerPlane{get;set;}
        /// <summary>
        /// Distance from a data coordinate to the left/right for setting a hotspot.
        /// </summary>
        public YUI_.DataType_.Number xMarkerPlaneOffset{get;set;}
        /// <summary>
        /// Reference to the `Axis` instance used for assigning
