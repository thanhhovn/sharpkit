...
namespace YUI_
{
    ...
    /// </summary>
    public partial class Recordset : YUI_.Base
    {
        /// <summary>
        ...
        /// Adds one or more Records to the RecordSet at the given index. If index is null, then adds the Records to the end of the RecordSet.
        /// </summary>
        public Recordset add(object oData, YUI_.DataType_.Number index){return null;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.DataType_.Number getLength(){return null;}
        /// <summary>
        ...
        /// </summary>
        public Record getRecordByIndex(YUI_.DataType_.Number i){return null;}
        /// <summary>
        /// Returns a range of records beginning at particular index
        /// </summary>
        public YUI_.Array getRecordsByIndex(YUI_.DataType_.Number index, YUI_.DataType_.Number range){return null;}
        /// <summary>
        ...
        /// record.
        /// </summary>
        public YUI_.Array getValuesByKey(){return null;}
        /// <summary>
        /// Gets an array of values for a data _key_ in the set's records.  If no _key_
        /// is supplied, the returned array will contain the full data object for each
        /// record.
        /// </summary>
        public YUI_.Array getValuesByKey(object key){return null;}
        /// <summary>
        ...
        /// is null, then removes a single Record from the end of the RecordSet.
        /// </summary>
        public Recordset remove(YUI_.DataType_.Number range){return null;}
        /// <summary>
        /// Removes one or more Records to the RecordSet at the given index. If index
        /// is null, then removes a single Record from the end of the RecordSet.
        /// </summary>
        public Recordset remove(YUI_.DataType_.Number index, YUI_.DataType_.Number range){return null;}
        /// <summary>
        ...
        /// records when updating the index with the new records.
        /// </summary>
        public Recordset update(object data, YUI_.DataType_.Number index){return null;}
        /// <summary>
