...
namespace YUI_.Text_
{
    ...
    public partial class WordBreak
    {
        ...
        /// </summary>
        protected YUI_.Array _classify(object @string){return null;}
        /// <summary>
        /// <p>
        ...
        /// </p>
        /// </summary>
        protected object _isWordBoundary(YUI_.Array map, YUI_.DataType_.Number index){return null;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.Array getUniqueWords(object @string, object options){return null;}
        /// <summary>
        /// Splits the specified string into an array of individual words.
        /// </summary>
        public YUI_.Array getWords(object @string, object options){return null;}
        /// <summary>
        /// <p>
        /// Returns <code>true</code> if there is a word boundary between the
        /// specified character index and the next character index (or the end of the
        ...
        /// </p>
        /// </summary>
        public object isWordBoundary(object @string, YUI_.DataType_.Number index){return null;}
    }
}
