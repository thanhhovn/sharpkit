...
namespace YUI_
{
    ...
    /// Resize.
    /// </summary>
    public partial class Resize : YUI_.Base
    {
        /// <summary>
        ...
        /// </summary>
        protected void _checkSize(object offset, YUI_.DataType_.Number size){}
        /// <summary>
        ...
        /// </summary>
        public YUI_.DataType_.Number defMinHeight{get;set;}
        /// <summary>
        /// The default minimum width of the element. Only used when
        /// ResizeConstrained is not plugged.
        /// </summary>
        public YUI_.DataType_.Number defMinWidth{get;set;}
        /// <summary>
