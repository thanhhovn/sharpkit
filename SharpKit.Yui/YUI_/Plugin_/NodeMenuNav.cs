...
namespace YUI_.plugin_
{
    ...
    public partial class NodeMenuNav
    {
        ...
        /// inside the menu.
        /// </summary>
        protected YUI_.DataType_.Number _currentMouseX{get;set;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.DataType_.Number mouseOutHideDelay{get;private set;}
        /// <summary>
        /// Number indicating the time (in milliseconds) that should expire before a
        /// submenu is hidden when the user mouses out of a menu label heading in the
        /// direction of a submenu.
        /// </summary>
        public YUI_.DataType_.Number submenuHideDelay{get;private set;}
        /// <summary>
        /// Number indicating the time (in milliseconds) that should expire before a
        /// submenu is made visible when the user mouses over the menu's label.
        /// </summary>
        public YUI_.DataType_.Number submenuShowDelay{get;private set;}
    }
}
