...
namespace YUI_.Plugin_
{
    ...
    /// </summary>
    public partial class DDConstrained : YUI_.Base
    {
        /// <summary>
        ...
        /// </summary>
        public object inRegion(YUI_.Array xy){return null;}
        /// <summary>
        ...
        /// </summary>
        public YUI_.Array tickXArray{get;set;}
        /// <summary>
        /// An array of page coordinates to use as Y ticks for drag movement.
        /// </summary>
        public YUI_.Array tickYArray{get;set;}
    }
}
