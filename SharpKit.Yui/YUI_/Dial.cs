...
namespace YUI_
{
    ...
    public partial class Dial : Widget
    {
        ...
        /// </summary>
        protected YUI_.DataType_.Number _getAngleFromHandleCenter(YUI_.DataType_.Number handleCenterX, YUI_.DataType_.Number handleCenterY){return null;}
        /// <summary>
        /// returns the handle angle associated with the current value of the Dial.
        /// Returns a number between 0 and 360.
        /// </summary>
        protected YUI_.DataType_.Number _getAngleFromValue(YUI_.DataType_.Number newVal){return null;}
        /// <summary>
        /// returns the value of the Dial calculated from the current handle angle
        /// </summary>
        protected YUI_.DataType_.Number _getValueFromAngle(YUI_.DataType_.Number angle){return null;}
        /// <summary>
        ...
        /// </summary>
        protected void _handleValuesBeyondMinMax(object e, YUI_.DataType_.Number newValue){}
        /// <summary>
        ...
        /// </summary>
        protected YUI_.Array _setNodeToFixedRadius(Node obj, object typeArray){return null;}
        /// <summary>
        /// sets the visible UI label HTML string
        /// </summary>
        ...
        /// </summary>
        protected void _uiSetValue(YUI_.DataType_.Number val){}
        /// <summary>
        /// value attribute default validator. Verifies that
        /// the value being set lies between the min/max value
        /// </summary>
        protected void _validateValue(YUI_.DataType_.Number val){}
        /// <summary>
        /// Changes a value to have the correct decimal places per the attribute decimalPlaces
        /// </summary>
        protected YUI_.DataType_.Number _valueToDecimalPlaces(YUI_.DataType_.Number val){return null;}
        /// <summary>
