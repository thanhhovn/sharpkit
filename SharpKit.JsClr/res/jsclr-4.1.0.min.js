...
{var action=BeforeCompilationFunctions[$i1];action();}
BeforeCompilationFunctions=new Array();for(var i=0;i<JsTypes.length;i++)
...
{var ce=JsTypes[$i2];if(ce.cctor!=null)
ce.cctor();}
JsTypes=new Array();}
...
{var funcs=AfterCompilationFunctions;AfterCompilationFunctions=new Array();for(var $i3=0;$i3<funcs.length;$i3++)
{var action=funcs[$i3];action();}
IsCompiled=true;}
