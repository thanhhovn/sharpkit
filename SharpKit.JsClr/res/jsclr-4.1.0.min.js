...
{var props=baseType.GetProperties();for(var $i10=0,$j10=props.length;$i10<$j10;$i10++)
{var pe=props[$i10];if(!this._PropertiesByName.hasOwnProperty(pe._Name))
...
{var methods=baseType.GetMethods();for(var $i11=0,$j11=methods.length;$i11<$j11;$i11++)
{var pe=methods[$i11];if(this._MethodsByName[pe._Name]==null)
...
{var methodName=SharpKit.JavaScript.JsNamingHelper.JsFunctionNameToClrMethodName(memberName);var methods=this.GetMethods$$String(methodName);for(var $i12=0,$j12=methods.length;$i12<$j12;$i12++)
{var method=methods[$i12];if(method.JsName==memberName)
return method;}
return null;}
...
{var prm=prms[$i14];sb.Append$$String("$$");sb.Append$$String(prm.get_ParameterType().get_Name());}},ClrMethodBaseToJsFunctionName:function(mi)
