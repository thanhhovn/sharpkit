...
{var ce=JsTypes[$i3];if(ce.cctor!=null)
ce.cctor();}
JsTypes=new Array();}
...
{var funcs=AfterCompilationFunctions;AfterCompilationFunctions=new Array();for(var $i4=0,$j4=funcs.length;$i4<$j4;$i4++)
{var action=funcs[$i4];action();}
IsCompiled=true;}
