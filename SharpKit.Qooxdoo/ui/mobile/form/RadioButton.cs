...
{
    /// <summary>
	/// <para>The Radio button for mobile.</para>
	/// <para>Example</para>
	/// <code>
	...
	/// </code>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.mobile.form.RadioButton", OmitOptionalParameters = true, Export = false)]
    public partial class RadioButton : qx.ui.mobile.form.Input
    {
		#region Events

		/// <summary>
		/// <para>Fired when the selection value is changed.</para>
		/// </summary>
		...
		public qx.ui.mobile.form.RadioGroup Group { get; set; }
		...
		public RadioButton(bool? value = null) { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Returns the (computed) value of the property group.</para>
		/// </summary>
		[JsMethod(Name = "getGroup")]
		public qx.ui.mobile.form.RadioGroup GetGroup() { throw new NotImplementedException(); }
		...
		/// <summary>
		/// <para>Sets the user value of the property group.</para>
		/// </summary>
		/// <param name="value">New value for property group.</param>
		[JsMethod(Name = "setGroup")]
		public void SetGroup(qx.ui.mobile.form.RadioGroup value) { throw new NotImplementedException(); }
