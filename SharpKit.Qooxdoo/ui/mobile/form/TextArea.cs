...
{
    /// <summary>
	/// <para>The TextArea is a multi-line text input field.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.mobile.form.TextArea", OmitOptionalParameters = true, Export = false)]
    public partial class TextArea : qx.ui.mobile.core.Widget, qx.ui.form.IForm, qx.ui.form.IModel
    {
		#region Events
		...
		public TextArea(object value = null) { throw new NotImplementedException(); }
