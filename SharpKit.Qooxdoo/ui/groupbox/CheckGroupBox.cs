...
{
    /// <summary>
	/// <para>A group box, which has a check box near the legend.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.groupbox.CheckGroupBox", OmitOptionalParameters = true, Export = false)]
    public partial class CheckGroupBox : qx.ui.groupbox.GroupBox, qx.ui.form.IExecutable, qx.ui.form.IBooleanForm, qx.ui.form.IModel
    {
		#region Events
		...
		public CheckGroupBox() { throw new NotImplementedException(); }
