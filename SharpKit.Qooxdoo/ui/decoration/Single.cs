...
{
    /// <summary>
	/// <para>A basic decorator featuring background colors and simple borders based on
	/// CSS styles.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.decoration.Single", OmitOptionalParameters = true, Export = false)]
    public partial class Single : qx.ui.decoration.Abstract
    {
		#region Properties
		...
		public Single(double width, string style, string color) { throw new NotImplementedException(); }
