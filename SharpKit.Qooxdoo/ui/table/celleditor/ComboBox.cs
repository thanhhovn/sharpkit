...
{
    /// <summary>
	/// <para>A cell editor factory creating combo boxes.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.ui.table.celleditor.ComboBox", OmitOptionalParameters = true, Export = false)]
    public partial class ComboBox : qx.core.Object, qx.ui.table.ICellEditorFactory
    {
		#region Properties
