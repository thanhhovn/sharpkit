...
{
    /// <summary>
	/// <para>An abstract data cell renderer that does the basic coloring
    ...
    public partial class Abstract : qx.core.Object, qx.ui.table.ICellRenderer
    {
		...
		/// <summary>
		/// <para>The default cell style. The value of this property will be provided
		/// to the cell renderer as cellInfo.style.</para>
		/// </summary>
		/// <remarks>
		/// Allow nulls: true
		/// </remarks>
		[JsProperty(Name = "defaultCellStyle", NativeField = true)]
		...
		/// <summary>
		/// <para>Returns the (computed) value of the property defaultCellStyle.</para>
		/// </summary>
		[JsMethod(Name = "getDefaultCellStyle")]
		public string GetDefaultCellStyle() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Calls the apply method and dispatches the change event of the property defaultCellStyle
		/// with the default value defined by the class developer. This function can
		/// only be called from the constructor of a class.</para>
		/// </summary>
		/// <param name="value">Initial value for property defaultCellStyle.</param>
		[JsMethod(Name = "initDefaultCellStyle")]
		public void InitDefaultCellStyle(object value) { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Resets the user value of the property defaultCellStyle.</para>
		/// <para>The computed value falls back to the next available value e.g. appearance, init or
		/// inheritance value depeneding on the property configuration and value availability.</para>
		/// </summary>
		[JsMethod(Name = "resetDefaultCellStyle")]
		public void ResetDefaultCellStyle() { throw new NotImplementedException(); }

		/// <summary>
		/// <para>Sets the user value of the property defaultCellStyle.</para>
		/// </summary>
		/// <param name="value">New value for property defaultCellStyle.</param>
		[JsMethod(Name = "setDefaultCellStyle")]
		public void SetDefaultCellStyle(string value) { throw new NotImplementedException(); }
