...
namespace qx.application
{
    ...
    public partial class AbstractGui : qx.core.Object, qx.application.IApplication
    {
		...
		public AbstractGui() { throw new NotImplementedException(); }
		...
		/// <summary>
		/// <para>Returns the application&#8217;s root widget. The root widgets can act as container
		/// for popups. It is configured with a <see cref="qx.ui.layout.Basic"/> (if the
		/// application is an inline application) layout or a <see cref="qx.ui.layout.Canvas"/>
		/// (if the application is a standalone application) layout .</para>
		/// <para>The root has the same add method as the configured layout
		/// (<see cref="qx.ui.layout.Basic"/> or <see cref="qx.ui.layout.Canvas"/>).</para>
		/// </summary>
		/// <returns>The application&#8217;s root widget.</returns>
		[JsMethod(Name = "getRoot")]
		public qx.ui.core.Widget GetRoot() { throw new NotImplementedException(); }
		...
		/// <summary>
		/// <para>Updates the GUI rendering</para>
		/// </summary>
