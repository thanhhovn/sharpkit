...
{
    /// <summary>
	/// <para>This handler provides a &#8220;load&#8221; event for iframes</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Iframe", OmitOptionalParameters = true, Export = false)]
    public partial class Iframe : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
