...
{
    /// <summary>
	/// <para>This class supports typical DOM element inline events like scroll,
	/// change, select, ...</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Element", OmitOptionalParameters = true, Export = false)]
    public partial class Element : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
		...
		public Element(qx.eventx.Manager manager) { throw new NotImplementedException(); }
