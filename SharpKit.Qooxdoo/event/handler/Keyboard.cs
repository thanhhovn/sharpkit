...
{
    /// <summary>
	/// <para>This class provides unified key event handler for Internet Explorer,
	/// Firefox, Opera and Safari.</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.event.handler.Keyboard", OmitOptionalParameters = true, Export = false)]
    public partial class Keyboard : qx.core.Object, qx.eventx.IEventHandler
    {
		#region Methods
		...
		public Keyboard(qx.eventx.Manager manager) { throw new NotImplementedException(); }
