...
{
    /// <summary>
	/// <para>This mixin contains the methods needed to implement a loader that will
	/// create a suite of unit tests from a given namespace and run it directly or
	/// provide the necessary information to a more advanced runner application</para>
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.dev.unit.MTestLoader", OmitOptionalParameters = true, Export = false)]
    public partial class MTestLoader 
    {
		#region Properties
		...
		public MTestLoader() { throw new NotImplementedException(); }
