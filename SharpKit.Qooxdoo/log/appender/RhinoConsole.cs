...
namespace qx.log.appender
{
	...
	/// </summary>
	[JsType(JsMode.Prototype, Name = "qx.log.appender.RhinoConsole", OmitOptionalParameters = true, Export = false)]
    public partial class RhinoConsole 
    {
		#region Methods

		public RhinoConsole() { throw new NotImplementedException(); }
